...
<section>
    ...
    <div class="cat">
            ...
            <div class="view bg1"></div>
            <div class="view bg2"></div>
            <div class="view bg3"></div>
            <div class="view bg4"></div>
            <div class="view"></div>
            <div class="view"></div>
            <div class="view"></div>
            <div class="view"></div>
...
.ap-enter-active , .ap-leave-active{
...
section{
    h2{
        ...
        border-left: solid 3vw rgb(243, 221, 23);
    }
        ...
        a{
            ...
            .sm{
                ...
                .desc{
                    ...
                    //border-bottom: solid 10px #cc4c35;
                    color: #111;
